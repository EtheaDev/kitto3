...
uses
  ...
  Vcl.Graphics, Vcl.Controls, Vcl.Forms, Vcl.Dialogs, VirtualTrees, VirtualTrees.EditLink,
  VirtualTrees.Types, VirtualTrees.Header, EF.Tree,
...
begin
  ...
  begin
    ...
    FTree.AddToSelection(Result, True);
  end
  else

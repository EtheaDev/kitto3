...
initialization
  TKExtControllerRegistry.Instance.RegisterClass('ExportFlexCelTool', TExportFlexCelToolController);

finalization
  TKExtControllerRegistry.Instance.UnregisterClass('ExportFlexCelTool');

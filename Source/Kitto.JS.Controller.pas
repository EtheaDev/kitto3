...
de-registration gracefully. }
  ...
  ///  friend to TKExtControllerRegistry.
  /// </summary>
...
procedure TKExtControllerRegistry.BeforeRegisterClass(const AId: string; const AClass: TClass);
begin
...
function TKExtControllerRegistry.GetClass(const AId: string): TJSObjectClass;
begin
...
procedure TKExtControllerRegistry.RegisterClass(const AId: string; const AClass: TJSObjectClass);
begin
...
var
  ...
  begin
    ...
    Result := TKExtControllerRegistry.Instance.GetClass(LType);
  end;
